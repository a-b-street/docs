...
[directly in your web browser](https://play.abstreet.org/0.3.46/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.46/abstreet_linux_v0_3_46.zip
unzip abstreet_linux_v0_3_46.zip
cd abstreet_linux_v0_3_46
./play_abstreet.sh
```
