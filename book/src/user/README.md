...
[directly in your web browser](https://play.abstreet.org/0.3.47/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.47/abstreet_linux_v0_3_47.zip
unzip abstreet_linux_v0_3_47.zip
cd abstreet_linux_v0_3_47
./play_abstreet.sh
```
