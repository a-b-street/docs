...
[directly in your web browser](http://play.abstreet.org/0.3.42/abstreet.html).
It's slower and there are some limitations compared to installing locally.

Grab a pre-built binary release:

- [Windows](https://github.com/a-b-street/abstreet/releases/download/v0.3.42/abstreet_windows_v0_3_42.zip)
...
- [Mac](https://github.com/a-b-street/abstreet/releases/download/v0.3.42/abstreet_mac_v0_3_42.zip)
...
- [Linux](https://github.com/a-b-street/abstreet/releases/download/v0.3.42/abstreet_linux_v0_3_42.zip)
  - Unzip the directory, then run `play_abstreet.sh`, e.g. with the following
    commands

```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.42/abstreet_linux_v0_3_42.zip
unzip abstreet_linux_v0_3_42.zip
cd abstreet_linux_v0_3_42
./play_abstreet.sh
```
