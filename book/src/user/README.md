...
[directly in your web browser](https://play.abstreet.org/0.3.43/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.43/abstreet_linux_v0_3_43.zip
unzip abstreet_linux_v0_3_43.zip
cd abstreet_linux_v0_3_43
./play_abstreet.sh
```
