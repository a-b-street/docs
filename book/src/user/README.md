...
[directly in your web browser](http://play.abstreet.org/0.3.8/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.8/abstreet_linux_v0_3_8.zip
unzip abstreet_linux_v0_3_8.zip
cd abstreet_linux_v0_3_8
./play_abstreet.sh
```
