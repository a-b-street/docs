...
[directly in your web browser](https://play.abstreet.org/0.3.45/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.45/abstreet_linux_v0_3_45.zip
unzip abstreet_linux_v0_3_45.zip
cd abstreet_linux_v0_3_45
./play_abstreet.sh
```
