...
[directly in your web browser](http://play.abstreet.org/0.3.40/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.40/abstreet_linux_v0_3_40.zip
unzip abstreet_linux_v0_3_40.zip
cd abstreet_linux_v0_3_40
./play_abstreet.sh
```
