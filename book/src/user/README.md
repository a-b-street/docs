...
[directly in your web browser](http://play.abstreet.org/0.3.30/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.30/abstreet_linux_v0_3_30.zip
unzip abstreet_linux_v0_3_30.zip
cd abstreet_linux_v0_3_30
./play_abstreet.sh
```
