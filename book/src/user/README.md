...
[directly in your web browser](http://play.abstreet.org/0.3.28/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.28/abstreet_linux_v0_3_28.zip
unzip abstreet_linux_v0_3_28.zip
cd abstreet_linux_v0_3_28
./play_abstreet.sh
```
