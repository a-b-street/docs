...
[directly in your web browser](http://play.abstreet.org/0.3.31/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.31/abstreet_linux_v0_3_31.zip
unzip abstreet_linux_v0_3_31.zip
cd abstreet_linux_v0_3_31
./play_abstreet.sh
```
