...
[directly in your web browser](http://play.abstreet.org/0.3.27/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.27/abstreet_linux_v0_3_27.zip
unzip abstreet_linux_v0_3_27.zip
cd abstreet_linux_v0_3_27
./play_abstreet.sh
```
