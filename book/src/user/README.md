...
[directly in your web browser](https://play.abstreet.org/0.3.48/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.48/abstreet_linux_v0_3_48.zip
unzip abstreet_linux_v0_3_48.zip
cd abstreet_linux_v0_3_48
./play_abstreet.sh
```
