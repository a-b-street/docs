...
[directly in your web browser](http://play.abstreet.org/0.3.12/abstreet.html).
...
```bash
cd ~/Downloads
wget https://github.com/a-b-street/abstreet/releases/download/v0.3.12/abstreet_linux_v0_3_12.zip
unzip abstreet_linux_v0_3_12.zip
cd abstreet_linux_v0_3_12
./play_abstreet.sh
```
